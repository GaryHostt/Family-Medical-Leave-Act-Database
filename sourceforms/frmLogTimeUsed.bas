...
Begin Form
    ...
    RecSrcDt = Begin
        0xb75bf45af913e540
    End
    RecordSource ="tblRequestTimeLog"
    Caption ="Log FMLA Time Used"
        ...
        Begin Section
            ...
            Begin
                ...
                Begin TextBox
                    ...
                    BorderColor =10921638
                    ForeColor =4210752
                    Name ="Time_used (hours)"
                    ControlSource ="Time_used"
                    EventProcPrefix ="Time_used__hours_"
                    GroupTable =1
                    BottomPadding =150
                    GridlineColor =10921638
                ...
                Begin ComboBox
                    ...
                    RowSource ="SELECT [qryActiveCertificates].[RequestNumber], [qryActiveCertificates].[Employe"
                        "e] FROM qryActiveCertificates ORDER BY [Employee]; "
